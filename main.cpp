...
string keyword[] = {"void", "int", "float", "double", "if", "else", "for", "do", "while",  "return", "include", "printf"};
char TOKEN[20];
...
int main(void){
    FILE * fp;
    fp = fopen ("/Users/lilongfei/CLionProjects/compile/test2.txt", "r");
    if (fp == NULL) {
        cout << "无法打开文件！" << endl;
        return 1;
    }
...
//    keywordMap["main"] = 48;
    ...
    do {
        ...
        if(isalpha(ch)) {
            ...
            else cout <<"("<< keywordMap[TOKEN] << ", )" << endl;
